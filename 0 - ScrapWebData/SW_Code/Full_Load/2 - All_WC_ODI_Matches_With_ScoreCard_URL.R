...
refFileWithPath <- paste(commonRefPath,"Abb_to_TeamName.csv",sep = "")
df_teamName <- read.csv(file = refFileWithPath,as.is=TRUE,header = TRUE)
...
#print(Summary_DF)
outputFileWithPath <- paste(outputPath,"All_WC_ODI_Matches.csv",sep = "")
