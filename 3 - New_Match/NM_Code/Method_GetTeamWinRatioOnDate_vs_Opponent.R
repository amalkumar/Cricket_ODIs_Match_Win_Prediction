...
GetTeamWinningRecordsOnDate_vs_Opponent <- function(teamName,opponentTeam,onDate){
  
  
  inputFileName <- "D:/Study_Material/DataAnalytics/GIT/ODIs/Output_Data/3 - New_Match/DC-1-TeamWinningRecord.csv"
  ...
  df_team_records <- df %>% filter(Match_Date<onDate,(Team1==teamName & Team2==opponentTeam) | (Team1==opponentTeam & Team2==teamName))
...
GetTeamWinningRecordsOnDate_vs_Opponent_Last5Matches <- function(teamName,opponentTeam,onDate){
