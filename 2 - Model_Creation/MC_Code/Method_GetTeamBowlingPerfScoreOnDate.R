...
TeamBowlingRecordsOnDate <- function(teamName,onDate){
  
  #####print(teamName)
  #####print("stage1")
  
  inputFileName <- "D:/Study_Material/DataAnalytics/GIT/ODIs/Output_Data/1 - Data_Creation/DC_Output/DC-3-bowling_record.csv"
  ...
  for (i in 1:nrow(df_team_bowling_records_onDate)) {
    ...
    df_bowler_records <- df_team_bowling_records %>% filter(bowler==bowlerToCalc,Match_Date<onDate)
    #####print("stage5")
...
TeamBowlingPerformanceOnDate <- function(teamName,onDate,Matches_wt=1,Strike_Rate_wt=1,Average_wt=1,Economy_wt=1,WicketsPerMatch_wt=1){
  
  rs <- TeamBowlingRecordsOnDate(teamName,onDate)
...
TeamBowlingRecordsOnDateLast5Matches <- function(teamName,onDate){
...
TeamBowlingPerformanceOnDateLast5Matches <- function(teamName,onDate,Matches_wt=1,Strike_Rate_wt=1,Average_wt=1,Economy_wt=1,WicketsPerMatch_wt=1){
  
  rs <- TeamBowlingRecordsOnDateLast5Matches(teamName,onDate)
